...
INTERPRETER_USE_OCR = os.getenv("INTERPRETER_USE_OCR", "False") == "True"
DOWNLOAD_PHOTOS = os.getenv("DOWNLOAD_PHOTOS", "True") == "True"
CLASSIFIER_USE_OCR = os.getenv("CLASSIFIER_USE_OCR", "False") == "True"
INTERPRETER_CLASSIFIER_MODE = os.getenv("INTERPRETER_CLASSIFIER_MODE", "stacked")
...
OCR_ONLY_ON_AS_EVENT_CLASSIFIED = os.getenv("OCR_ONLY_ON_AS_EVENT_CLASSIFIED", "True") == "True"
